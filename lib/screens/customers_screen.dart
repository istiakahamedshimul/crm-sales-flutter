...
class _CustomersScreenState extends State<CustomersScreen> {
  ...
  void _load() {
    customers = apiClient.getBookedCustomers().then((list) {
        ...
        builder: (context, snapshot) {
          ...
          if (data.isEmpty) {
            return const EmptyState(
              text:
                  'No booked customers yet. A booked lead appears here automatically.',
            );
          }
      ...
      builder: (context) => StatefulBuilder(builder: (context, setSheetState) {
        ...
        return Padding(
          ...
          child: Column(mainAxisSize: MainAxisSize.min, children: [
            Text('Update ${customer.name} project',
                style: Theme.of(context).textTheme.titleLarge),
            const SizedBox(height: 16),
            DropdownButtonFormField<int>(
              value: subgroupId,
              decoration: const InputDecoration(
                  labelText: 'Subgroup (Real Capital Group)'),
              items: [
            ...
            DropdownButtonFormField<int>(
              ...
              items: [
                for (final value in types)
                  DropdownMenuItem(
                      value: value, child: Text(_projectType(value)))
              ],
...
class _CustomerCard extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final project = customer.project == null
        ? 'No project assigned'
        ...
        children: [
          ...
          Row(
            children: [
              ...
              Expanded(
                child:
                    Text(project, maxLines: 1, overflow: TextOverflow.ellipsis),
              ),
            ],
          ),
          const SizedBox(height: 10),
